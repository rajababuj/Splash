        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li><a class="nav-link" href="{{ route('user.service') }}">Services</a></li>
                    <li><a class="nav-link" href="{{ route('user.blog') }}">Blog</a></li>
            ...
            <div class="row mb-5">
                <div class="col-md-12">
                    <div class="border p-4 rounded" role="alert">
                        Returning customer? <a href="{{route('user.logout')}}">Click here</a> to login
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12">
                            ...
                            <div class="p-3 p-lg-5 border bg-white">
                                ...
                                <div class="form-group">
                                    <a href="{{ route('user.thankyou') }}" class="btn btn-black btn-lg py-3 btn-block">Place Order</a>
                                </div>
