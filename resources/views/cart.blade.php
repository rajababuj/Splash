        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li><a class="nav-link" href="{{ route('user.blog') }}">Interests</a></li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="product-thumbnail">
                                        <img class="img-fluid" alt="Image" src="{{ $cartItem->category->image }}">
                                    </td>
                                    <td class="product-name">
                                        <h2 class="h5 text-black">{{ $cartItem->category->name }}</h2>
                                    </td>
                                    <td>${{ $cartItem->category->price }}</td>
                                    <td>
